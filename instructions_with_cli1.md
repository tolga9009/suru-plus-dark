...
svn export https://github.com/suru-plus/SURU-PLUS-DARK/trunk/ ~/.icons/Suru++\ Dark
# To update the next latest changes and to overwrite
svn export --force https://github.com/Magog64/SURU-PLUS/trunk/ ~/.icons/Suru++
svn export --force https://github.com/suru-plus/SURU-PLUS-DARK/trunk/ ~/.icons/Suru++\ Dark
```