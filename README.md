...
* [Suru++ Lubuntu](https://github.com/suru-plus/suru-plus-lubuntu/)
* [Suru++ Dark Lubuntu](https://github.com/suru-plus/suru-plus-dark-lubuntu/)
...
We provide desktop files (AppImage, native Debian packages, snap app and source codes) for you for being able of applying correctly the icons. You can download them from the repository  <a href="https://github.com/suru-plus/suru-plus/tree/master/desktop">Suru++</a>. Copy them to `your_name/local/applications/`, so they won't be reverted to original when you make next updates of Ubuntu and/or PPAs.
