...
```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-dark/master/install.sh | sh
```

#### HOME directory for GTK

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-dark/master/install.sh | env DESTDIR="$HOME/.icons" sh
```

#### HOME directory for KDE

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-dark/master/install.sh | env DESTDIR="$HOME/.local/share/icons" sh
```

#### \*BSD systems

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-dark/master/install.sh | env DESTDIR="/usr/local/share/icons" sh
```

#### Uninstall

```
wget -qO- https://raw.githubusercontent.com/suru-plus/suru-plus-dark/master/install.sh | env uninstall=true sh
```

## Changing the folder colour

Please visit directly the tutorial: [Suru++ Folders](https://github.com/suru-plus/suru-plus-folders). The tutorial is translated in 7 languages.
...
* GPL3 © 2018-2019 [Suru++ Ubuntu](https://github.com/Magog64/suru-plus) by [Andrea Bonanni](https://github.com/Magog64) and Suru++ Project.
* GPL3 © 2018-2019 Suru++ 25 by Suru++ Project.
